...
namespace watchstore.Data
{
    ...
    {
        public static void Initialize(ApplicationDbContext context, IServiceProvider service)
        {
        ...
        private static void CreateAdminRole(ApplicationDbContext context, RoleManager<IdentityRole> _roleManager, UserManager<IdentityUser> _userManager)
        {
        ...
        private static void Seed(ApplicationDbContext _context, RoleManager<IdentityRole> _roleManager, UserManager<IdentityUser> _userManager)
        {
        ...
        private static void Clear(ApplicationDbContext _context)
        {
