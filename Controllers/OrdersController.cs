...
namespace watchstore.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Checkout(Order order)
        {
            ...
            {
                ModelState.AddModelError("", "Your cart is empty, add some watchs first");
            }
        ...
        {
            ViewBag.CheckoutCompleteMessage = $"Thanks for your order, We'll deliver your watchs soon!";
            return View();
        }
        ...
        public async Task<IActionResult> Details(int id)
        {
            ...
            var orderDetailsList = _context.OrderDetails.Include(o => o.Watch).Include(o => o.Order)
